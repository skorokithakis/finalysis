"""
Django settings for finalysis project.
...
MIDDLEWARE = [
    ...
    "finalysis.middleware.StatsMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "finalysis.context_processors.settings",
            ]
        },
    }
]
...
WSGI_APPLICATION = "finalysis.wsgi.application"
